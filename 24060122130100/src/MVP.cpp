...
public:
    ...
    void start() override {
        ...
        cube_3->transform = glm::rotate(cube_3->transform, glm::radians(90.f), vec3( 0, 1, 0));
    ...
    void update() override {
        ...
        switch (camera_mode) {
            ...
            case CAMERA_MODE::PROJECTION_1:
                ...
                ProjectionMatrix = glm::perspective<float>(glm::radians(50.f), aspect_ratio, 0.1f, 1000.0f);
                break;  
